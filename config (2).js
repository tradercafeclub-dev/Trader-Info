...
let editWalletIdx=-1;
let commSelectedTeam=null, commSelectedMonth=null, commDashMonth=null, commDashPage=0;
const COMM_DASH_PAGE_SIZE=10;
let adminCommSelectedMonth=null;
let commApprovals={};
const COMM_APPROVALS_KEY='tcc_comm_approvals';
let currentPage_main='home';
let pexPage=0;
const PEX_PAGE_SIZE=20;
let pexSearchText='', pexTypeFilter='all', pexStatusFilter='', pexMonthFilter='', pexTimeMode='all';
